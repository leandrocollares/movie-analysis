vis.movieLanguages = vis.movieLanguages || {};

vis.movieLanguages.init = function() {
  ...
  var svg = d3.select("#movie-languages #movieLanguages").append("svg")
  ...
  d3.csv("slides/slide_04/movieLanguages.csv", function(error, data) {
