vis.movieTitles = vis.movieTitles || {};

vis.movieTitles.init = function() {
  ...
  var svg = d3.select("#movie-titles #movieTitles").append("svg")
  ...
  d3.csv("slides/slide_03/movieTitles.csv", function(error, data) {
